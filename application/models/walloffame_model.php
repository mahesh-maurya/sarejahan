...
{
    public function create($name,$deed,$status,$fromemail,$toemail,$date,$place,$shortdeed,$image)
    {
        $data=array(
            "deed" => $deed,
            "name" => $name,
    ...
    public function edit($id,$name,$deed,$status,$fromemail,$toemail,$date,$place,$shortdeed,$image)
    {
        $data=array(
            "deed" => $deed,
            "name" => $name,
...
ORDER BY `walloffame`.`order`")->result();
    ...
    public function adddeed($name,$deed,$fromemail,$toemail,$date,$place,$shortdeed,$image)
    {
        if($fromemail=="")
        {
	...
	public function getwalloffameimagebyid($id)
	{
		$query=$this->db->query("SELECT `image` FROM `walloffame` WHERE `id`='$id'")->row();
		return $query;
	}
}
?>
